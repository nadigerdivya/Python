...
# Create Banking System to perform following :

#     1. Prompt user to ask whether they want to create a new Savings account or access existing account
#     2. If the user wants to create new account, ask for name and initial deposit and create 5 digit random account number
#     3. If the user wants to access existing account, ask for name, account number to validate the user. 
#         Once validated, provide options to withdraw, deposite or display the amount to the account.
